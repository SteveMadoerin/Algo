...
public class AdjacencyListDirectedGraph<V> implements DirectedGraph<V> {
	...
	{
		//wenn knoten im Grafen nicht vorhanden
		if(!containsVertex(v))
		{
	...
	public String toString() {
		...
		for(var v : succ.entrySet())
		{
			...
			{
				sb.append(v.getKey()).append(" -->").append(edge.getKey()).append(" weight = ").append(edge.getValue()).append("\n");
			}
		}
		return sb.toString();
	}
	...
	public static void main(String[] args) {
		...
		//s.remove(5);	// Laufzeitfehler! Warum? weil get vertexset unmodifiab
	}
}
